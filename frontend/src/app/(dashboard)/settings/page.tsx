...
export default function SettingsPage() {
  ...
  // 2. Initialize Google Client once script loads
  ...
  // 3. Handle the OAuth Code Exchange
          ...
          <form onSubmit={handleSave} className="space-y-6">
             ...
             <div className="pt-4 border-t border-border">
                ...
                <button 
                  type="submit" 
                  disabled={isSaving}
                  className="w-full bg-primary hover:bg-violet-500 text-white font-bold py-3 rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
